...
Int_t ProducePi0MesonDalitzResults(TString fileNameppDalitz 	= "ExternalInput/Dalitz/data_PCMResultsFullCorrection_PP_NoBinShifting_20150720.root", 
	...
	//cout<<"graphNLO prueba prueba";
	//graphNLOCalcmuTwoDSS14InvSecPi02760GeV->Print();
	...
	Double_t parametersTsallis2760GeV[3] 		= {2.18,6.88,0.139}; 
	Double_t parametersTsallisInvCross2760GeV[3]    = {1.0e12,6.88,0.139};
		
	Double_t parametersTsallis7TeV[3]    		= {2.3,6.3,0.14};
	...
	fitTsallisInvCrossSectionPi02760GeV->SetRange(0.6, maxPtPi0);
	...
	graphDalitzPi0InvCrossSectionCompl2760GeV->Fit(fitTsallisInvCrossSectionPi02760GeV,"QNRMEX0+","",0.6,maxPtPi0);
	graphDalitzPi0InvCrossSectionCompl2760GeV->Fit(fitTsallisInvCrossSectionPi02760GeV,"QNRMEX0+","",0.6,maxPtPi0);
	...
	fitTsallisInvCrossSectionPi07TeV->SetRange(0.6, maxPtPi0);
	...
	graphDalitzPi0InvCrossSectionCompl7TeV->Fit(fitTsallisInvCrossSectionPi07TeV,"QNRMEX0+","",0.6,maxPtPi0);
	graphDalitzPi0InvCrossSectionCompl7TeV->Fit(fitTsallisInvCrossSectionPi07TeV,"QNRMEX0+","",0.6,maxPtPi0);
	...
	TH1F* fitHistogramBylinkinDalitzPi0InvCrossSection2760GeV = (TH1F*)fitBylinkinDalitzPi0InvCrossSection2760GeV->GetHistogram();
	...
	legendPlotLabel->SetTextSize(0.030);
...
//  	//*************** third Column **********************************************************
	...
	DrawGammaSetMarkerTGraphAsym(graphRatioInvCrossSectionPi07TeVBylinkinFit, markerStyleCommmonSpectrumPi07TeV,markerSizeCommonSpectrumPi07TeV, colorCommonSpectrumPi07TeV, colorCommonSpectrumPi07TeV, widthCommonSpectrumBoxes,kTRUE,colorCommonSpectrumPi07TeV);
...
// 	//*************** third Column **********************************************************
	...
	canvasInvXSectionNLODSS14OnlySpectraPi0->Print(Form("%s/InvariantCrossSecPP_pQCD_DSS14.%s",outputDir.Data(),suffix.Data()));
	...
	canvasInvXSectionNLODSS14OnlyRatioPi0->Print(Form("%s/Pi0_InvXSectionNLO_OnlyRatio_DSS14.%s",outputDir.Data(),suffix.Data()));
