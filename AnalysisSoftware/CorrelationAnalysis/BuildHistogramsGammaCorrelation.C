...
void BuildHistogramsGammaCorrelation(TString fileName = "kkoch_GammaConvMaterialTree.root", TString CutSelection="00000" , Int_t kMC=0, Bool_t merge=0, TString nameAddition =""){
   ...
   Double_t        ptLeadingChargedGamma;
   Int_t           indexLeadingChargedGamma;
   Int_t           nAssociatedChGamma;
   Int_t           nAssociatedGammaGamma;
	UChar_t         prodProcLeadingGamma;
   Int_t           originLeadingGamma;
   ...
   TVectorF * isoChAssosiatedGamma= new TVectorF;
	...
	TTree* treeCorrGamma = (TTree*)gDirectory->Get("GammaCorr");
 
   treeCorrGamma->SetBranchAddress("ptLeadingGamma", &ptLeadingGamma);
	treeCorrGamma->SetBranchAddress("phiLeadingGamma", &phiLeadingGamma);
   treeCorrGamma->SetBranchAddress("etaLeadingGamma", &etaLeadingGamma);
   treeCorrGamma->SetBranchAddress("ptLeadingCharged", &ptLeadingChargedGamma);
	treeCorrGamma->SetBranchAddress("indexLeadingCharged", &indexLeadingChargedGamma);
	...
	if (kMC ==1){
		treeCorrGamma->SetBranchAddress("prodProcLeadingGamma",&prodProcLeadingGamma);
		treeCorrGamma->SetBranchAddress("originLeadingGamma",&originLeadingGamma);
	}
   ...
   treeCorrGamma->SetBranchAddress("isoChAssosiated.", &isoChAssosiatedGamma);
	if (kMC ==1){
		treeCorrGamma->SetBranchAddress("prodProcGammaAssosiated.",&prodProcGammaAssosiated);
		treeCorrGamma->SetBranchAddress("originGammaAssosiated.",&originGammaAssosiated);
	}
	...
	Int_t nProdProcess = 15;
	Double_t firstBinProdProcess = -0.5;
	Double_t lastBinProdProcess = 14.5;
	...
	TH1F* histoOriginGammas;
	TH1F* histoProdProcessGammas;
	TH2F* histoCorrTrueGamma_Phi_Eta;
	TH2F* histoCorrTrueGamma_IsoMin_Pt;
	TH2F* histoCorrTrueGamma_dPhiCh_dEtaCh;
	TH2F* histoCorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT2GeV;
	TH2F* histoCorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT5GeV;
	TH3F* histoCorrTrueGamma_dPhiCh_PtAssoc_PtTrig;
	TH3F* histoCorrTrueGamma_dEtaCh_PtAssoc_PtTrig;
	TH3F* histoCorrTrueGamma_PoutCh_PtAssoc_PtTrig;
	TH2F* histoCorrTrueGamma_IsoCh_PtTrig;
	TH2F* histoCorrTrueGamma_dPhiGa_dEtaGa ;
	TH3F* histoCorrTrueGamma_dPhiGa_PtAssoc_PtTrig;
	TH3F* histoCorrTrueGamma_dEtaGa_PtAssoc_PtTrig;
	TH2F* histoCorrTrueGamma_IsoGa_PtTrig;
	TH3F* histoCorrTrueGammaIso_dPhiCh_PtAssoc_PtTrig;
	TH3F* histoCorrTrueGammaIso_dEtaCh_PtAssoc_PtTrig;

	
	TString fileNameOutput;
	if (kMC==1){
		fileNameOutput = Form("GammaConvCorr_%s_MCrec.root",nameAddition.Data());
	} else if (kMC==0){
		fileNameOutput = Form("GammaConvCorr_%s_Data.root",nameAddition.Data());
	} 
	...
	if (!merge || directoryGammaCorr==0) {			
		...
		if (kMC==1){
			histoOriginGammas =  new TH1F("ESD_OriginGamma","", nOrigin, firstBinOrigin, lastBinOrigin);
			histoProdProcessGammas =  new TH1F("ESD_ProdProcessGammas","", nProdProcess, firstBinProdProcess, lastBinProdProcess);
			histoCorrTrueGamma_Phi_Eta =  new TH2F("ESD_CorrTrueGamma_Phi_Eta","", nPhiCorr, firstBinPhiCorr, lastBinPhiCorr, nEtaCorr, firstBinEtaCorr, lastBinEtaCorr);	
			histoCorrTrueGamma_dPhiCh_dEtaCh =  new TH2F("ESD_CorrTrueGamma_dPhiCh_dEtaCh","", ndPhiCorr , firstBindPhiCorr, lastBindPhiCorr, ndEtaCorr, firstBindEtaCorr, lastBindEtaCorr);
			histoCorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT2GeV =  new TH2F("ESD_CorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT2GeV","", ndPhiCorr , firstBindPhiCorr, lastBindPhiCorr, ndEtaCorr, firstBindEtaCorr, lastBindEtaCorr);
			histoCorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT5GeV =  new TH2F("ESD_CorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT5GeV","", ndPhiCorr , firstBindPhiCorr, lastBindPhiCorr, ndEtaCorr, firstBindEtaCorr, lastBindEtaCorr);
			histoCorrTrueGamma_dPhiCh_PtAssoc_PtTrig =  new TH3F("ESD_CorrTrueGamma_dPhiCh_PtAssoc_PtTrig","", ndPhiCorr, firstBindPhiCorr, lastBindPhiCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr);
			histoCorrTrueGamma_dEtaCh_PtAssoc_PtTrig =  new TH3F("ESD_CorrTrueGamma_dEtaCh_PtAssoc_PtTrig","", ndEtaCorr, firstBindEtaCorr, lastBindEtaCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr);
			histoCorrTrueGamma_PoutCh_PtAssoc_PtTrig =  new TH3F("ESD_CorrTrueGamma_PoutCh_PtAssoc_PtTrig","", nPtCorr, firstBinPtCorr, lastBinPtCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr);
			
			histoCorrTrueGamma_IsoCh_PtTrig = new TH2F("ESD_CorrTrueGamma_IsoCh_PtTrig","", nIsoCorr, firstBinIsoCorr, lastBinIsoCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr);
			histoCorrTrueGamma_dPhiGa_dEtaGa =  new TH2F("ESD_CorrTrueGamma_dPhiGa_dEtaGa","", ndPhiCorr , firstBindPhiCorr, lastBindPhiCorr, ndEtaCorr, firstBindEtaCorr, lastBindEtaCorr);
			histoCorrTrueGamma_dPhiGa_PtAssoc_PtTrig =  new TH3F("ESD_CorrTrueGamma_dPhiGa_PtAssoc_PtTrig","", ndPhiCorr, firstBindPhiCorr, lastBindPhiCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr);
			histoCorrTrueGamma_dEtaGa_PtAssoc_PtTrig =  new TH3F("ESD_CorrTrueGamma_dEtaGa_PtAssoc_PtTrig","", ndEtaCorr, firstBindEtaCorr, lastBindEtaCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr);
			histoCorrTrueGamma_IsoGa_PtTrig = new TH2F("ESD_CorrTrueGamma_IsoGa_PtTrig","", nIsoCorr, firstBinIsoCorr, lastBinIsoCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr);
			histoCorrTrueGamma_IsoMin_Pt =  new TH2F("ESD_CorrTrueGamma_IsoMin_Pt","", nIsoCorr, firstBinIsoCorr, lastBinIsoCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr);
			histoCorrTrueGammaIso_dPhiCh_PtAssoc_PtTrig =  new TH3F("ESD_CorrTrueGammaIso_dPhiCh_PtAssoc_PtTrig","", ndPhiCorr, firstBindPhiCorr, lastBindPhiCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr);
			histoCorrTrueGammaIso_dEtaCh_PtAssoc_PtTrig =  new TH3F("ESD_CorrTrueGammaIso_dEtaCh_PtAssoc_PtTrig","", ndEtaCorr, firstBindEtaCorr, lastBindEtaCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr, nPtCorr, firstBinPtCorr, lastBinPtCorr);				
		}
		...
		if (kMC ==1){
			histoOriginGammas = (TH1F*)directoryGammaCorr->Get("ESD_OriginGamma");
			histoProdProcessGammas = (TH1F*)directoryGammaCorr->Get("ESD_ProdProcessGammas");
			histoCorrTrueGamma_Phi_Eta = (TH2F*)directoryGammaCorr->Get("ESD_CorrTrueGamma_Phi_Eta");
			histoCorrTrueGamma_dPhiCh_dEtaCh = (TH2F*)directoryGammaCorr->Get("ESD_CorrTrueGamma_dPhiCh_dEtaCh");
			histoCorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT2GeV = (TH2F*)directoryGammaCorr->Get("ESD_CorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT2GeV");
			histoCorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT5GeV = (TH2F*)directoryGammaCorr->Get("ESD_CorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT5GeV");
			histoCorrTrueGamma_dPhiCh_PtAssoc_PtTrig = (TH3F*)directoryGammaCorr->Get("ESD_CorrTrueGamma_dPhiCh_PtAssoc_PtTrig");
			histoCorrTrueGamma_dEtaCh_PtAssoc_PtTrig = (TH3F*)directoryGammaCorr->Get("ESD_CorrTrueGamma_dEtaCh_PtAssoc_PtTrig");
			histoCorrTrueGamma_PoutCh_PtAssoc_PtTrig =  (TH3F*)directoryGammaCorr->Get("ESD_CorrTrueGamma_PoutCh_PtAssoc_PtTrig");
			histoCorrTrueGamma_IsoCh_PtTrig = (TH2F*)directoryGammaCorr->Get("ESD_CorrTrueGamma_IsoCh_PtTrig");
			histoCorrTrueGamma_dPhiGa_dEtaGa =(TH2F*)directoryGammaCorr->Get("ESD_CorrTrueGamma_dPhiGa_dEtaGa");
			histoCorrTrueGamma_dPhiGa_PtAssoc_PtTrig =(TH3F*)directoryGammaCorr->Get("ESD_CorrTrueGamma_dPhiGa_PtAssoc_PtTrig");
			histoCorrTrueGamma_dEtaGa_PtAssoc_PtTrig =(TH3F*)directoryGammaCorr->Get("ESD_CorrTrueGamma_dEtaGa_PtAssoc_PtTrig");
			histoCorrTrueGamma_IsoGa_PtTrig = (TH2F*)directoryGammaCorr->Get("ESD_CorrTrueGamma_IsoGa_PtTrig");
			histoCorrTrueGamma_IsoMin_Pt = (TH2F*)directoryGammaCorr->Get("ESD_CorrTrueGamma_IsoMin_Pt");
			histoCorrTrueGammaIso_dPhiCh_PtAssoc_PtTrig = (TH3F*)directoryGammaCorr->Get("ESD_CorrTrueGammaIso_dPhiCh_PtAssoc_PtTrig");
			histoCorrTrueGammaIso_dEtaCh_PtAssoc_PtTrig = (TH3F*)directoryGammaCorr->Get("ESD_CorrTrueGammaIso_dEtaCh_PtAssoc_PtTrig");
		...
		if (kMC ==1){
			histoOriginGammas->Sumw2();
			histoProdProcessGammas->Sumw2();
			histoCorrTrueGamma_Phi_Eta->Sumw2();
			histoCorrTrueGamma_dPhiCh_dEtaCh->Sumw2();
			histoCorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT2GeV->Sumw2();
			histoCorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT5GeV->Sumw2();
			histoCorrTrueGamma_dPhiCh_PtAssoc_PtTrig->Sumw2();
			histoCorrTrueGamma_dEtaCh_PtAssoc_PtTrig->Sumw2();
			histoCorrTrueGamma_PoutCh_PtAssoc_PtTrig->Sumw2();
			histoCorrTrueGamma_IsoCh_PtTrig->Sumw2();
			histoCorrTrueGamma_dPhiGa_dEtaGa->Sumw2();
			histoCorrTrueGamma_dPhiGa_PtAssoc_PtTrig->Sumw2();
			histoCorrTrueGamma_dEtaGa_PtAssoc_PtTrig->Sumw2();
			histoCorrTrueGamma_IsoGa_PtTrig->Sumw2();
			histoCorrTrueGamma_IsoMin_Pt->Sumw2();
			histoCorrTrueGammaIso_dPhiCh_PtAssoc_PtTrig->Sumw2();
			histoCorrTrueGammaIso_dEtaCh_PtAssoc_PtTrig->Sumw2();
		}
	}
   ...
   Long64_t nbytesGamma = 0;
	for (Long64_t i=0; i<nEntriesCorrGamma;i++) {
		...
		if (ptLeadingGamma > minPtPhotonCut && TMath::Abs(etaLeadingGamma) < etaMaxCut-0.2){ //&& ptLeadingGamma > ptLeadingChargedGamma
			...
			if (kMC==1){
				if (prodProcLeadingGamma != 0){
					histoProdProcessGammas->Fill(prodProcLeadingGamma);
					histoOriginGammas->Fill(originLeadingGamma);
				}
				if (prodProcLeadingGamma == 5 || prodProcLeadingGamma == 6 ){
					histoCorrTrueGamma_Phi_Eta->Fill(phiLeadingGamma,etaLeadingGamma);
				}
			...
			for (Int_t j = 0; j < nAssociatedChGamma; j++){
				...
				if (ptLeadingGamma> 2 && (*ptChAssociatedGamma)[j]> 1){
					...
					if (kMC == 1 && (prodProcLeadingGamma == 5 || prodProcLeadingGamma == 6 )){
						histoCorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT2GeV->Fill((*dPhiChAssosiatedGamma)[j],(*dEtaChAssosiatedGamma)[j]);
					}
				}
				if (ptLeadingGamma> 5 && (*ptChAssociatedGamma)[j]> 1){
					...
					if (kMC == 1 && (prodProcLeadingGamma == 5 || prodProcLeadingGamma == 6 )){
						histoCorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT5GeV->Fill((*dPhiChAssosiatedGamma)[j],(*dEtaChAssosiatedGamma)[j]);
					}
				}
				...
				if (kMC == 1 && (prodProcLeadingGamma == 5 || prodProcLeadingGamma == 6 )){
					histoCorrTrueGamma_dPhiCh_dEtaCh->Fill((*dPhiChAssosiatedGamma)[j],(*dEtaChAssosiatedGamma)[j]);
					histoCorrTrueGamma_dPhiCh_PtAssoc_PtTrig->Fill((*dPhiChAssosiatedGamma)[j],(*ptChAssociatedGamma)[j],ptLeadingGamma);
					histoCorrTrueGamma_dEtaCh_PtAssoc_PtTrig->Fill((*dEtaChAssosiatedGamma)[j],(*ptChAssociatedGamma)[j],ptLeadingGamma);
					histoCorrTrueGamma_PoutCh_PtAssoc_PtTrig->Fill((*ptChAssociatedGamma)[j]*TMath::Sin((*dPhiChAssosiatedGamma)[j]),(*ptChAssociatedGamma)[j],ptLeadingGamma);
				}
			...
			if (kMC == 1 && (prodProcLeadingGamma == 5 || prodProcLeadingGamma == 6 )){
				histoCorrTrueGamma_IsoMin_Pt->Fill(isoMin,ptLeadingGamma);
			}
			if (sumPtCone < maxSumInCone* ptLeadingGamma){
				for (Int_t j = 0; j < nAssociatedChGamma; j++){
					...
					if (kMC == 1 && (prodProcLeadingGamma == 5 || prodProcLeadingGamma == 6 )){
						histoCorrTrueGammaIso_dPhiCh_PtAssoc_PtTrig->Fill((*dPhiChAssosiatedGamma)[j],(*ptChAssociatedGamma)[j],ptLeadingGamma);
						histoCorrTrueGammaIso_dEtaCh_PtAssoc_PtTrig->Fill((*dEtaChAssosiatedGamma)[j],(*ptChAssociatedGamma)[j],ptLeadingGamma);
					}
				}
			}
			...
			for (Int_t k = 0; k < nAssociatedGammaGamma; k++){
				...
				if (kMC == 1 && (prodProcLeadingGamma == 5 || prodProcLeadingGamma == 6 )){
					histoCorrTrueGamma_dPhiGa_dEtaGa->Fill((*dPhiGammaAssosiatedGamma)[k],(*dEtaGammaAssosiatedGamma)[k]);
					histoCorrTrueGamma_dPhiGa_PtAssoc_PtTrig->Fill((*dPhiGammaAssosiatedGamma)[k],(*ptGammaAssosiatedGamma)[k],ptLeadingGamma);
					histoCorrTrueGamma_dEtaGa_PtAssoc_PtTrig->Fill((*dEtaGammaAssosiatedGamma)[k],(*ptGammaAssosiatedGamma)[k],ptLeadingGamma);
					histoCorrTrueGamma_IsoGa_PtTrig->Fill((*isoGammaAssosiatedGamma)[k],ptLeadingGamma);
				}
			}			
		}
	}
	...
	fileCorrWrite->cd(Form("CorrGamma_%s",  CutSelection.Data()));
		...
		if (kMC ==1){
			histoOriginGammas->Write("ESD_OriginGamma",TObject::kWriteDelete);	
			histoProdProcessGammas->Write("ESD_ProdProcessGammas",TObject::kWriteDelete);	
			histoCorrTrueGamma_Phi_Eta->Write("ESD_CorrTrueGamma_Phi_Eta",TObject::kWriteDelete);		
			histoCorrTrueGamma_dPhiCh_dEtaCh->Write("ESD_CorrTrueGamma_dPhiCh_dEtaCh",TObject::kWriteDelete);		
			histoCorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT2GeV->Write("ESD_CorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT2GeV",TObject::kWriteDelete);		
			histoCorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT5GeV->Write("ESD_CorrTrueGamma_dPhiCh_dEtaCh_PtA1GeV_PtT5GeV",TObject::kWriteDelete);		
			histoCorrTrueGamma_dPhiCh_PtAssoc_PtTrig->Write("ESD_CorrTrueGamma_dPhiCh_PtAssoc_PtTrig",TObject::kWriteDelete);		
			histoCorrTrueGamma_dEtaCh_PtAssoc_PtTrig->Write("ESD_CorrTrueGamma_dEtaCh_PtAssoc_PtTrig",TObject::kWriteDelete);		
			histoCorrTrueGamma_PoutCh_PtAssoc_PtTrig->Write("ESD_CorrTrueGamma_PoutCh_PtAssoc_PtTrig",TObject::kWriteDelete);		
			histoCorrTrueGamma_IsoCh_PtTrig->Write("ESD_CorrTrueGamma_IsoCh_PtTrig",TObject::kWriteDelete);		
			histoCorrTrueGamma_dPhiGa_dEtaGa->Write("ESD_CorrTrueGamma_dPhiGa_dEtaGa",TObject::kWriteDelete);		
			histoCorrTrueGamma_dPhiGa_PtAssoc_PtTrig->Write("ESD_CorrTrueGamma_dPhiGa_PtAssoc_PtTrig",TObject::kWriteDelete);		
			histoCorrTrueGamma_dEtaGa_PtAssoc_PtTrig->Write("ESD_CorrTrueGamma_dEtaGa_PtAssoc_PtTrig",TObject::kWriteDelete);		
			histoCorrTrueGamma_IsoGa_PtTrig->Write("ESD_CorrTrueGamma_IsoGa_PtTrig",TObject::kWriteDelete);		
			histoCorrTrueGamma_IsoMin_Pt->Write("ESD_CorrTrueGamma_IsoMin_Pt",TObject::kWriteDelete);		
			histoCorrTrueGammaIso_dPhiCh_PtAssoc_PtTrig->Write("ESD_CorrTrueGammaIso_dPhiCh_PtAssoc_PtTrig",TObject::kWriteDelete);		
			histoCorrTrueGammaIso_dEtaCh_PtAssoc_PtTrig->Write("ESD_CorrTrueGammaIso_dEtaCh_PtAssoc_PtTrig",TObject::kWriteDelete);		
		}
	...
	delete histoOriginGammas;
	delete histoProdProcessGammas;
	if (kMC ==1){
		...
		delete histoCorrTrueGamma_PoutCh_PtAssoc_PtTrig;
		delete histoCorrTrueGamma_IsoCh_PtTrig;
		...
		delete histoCorrTrueGamma_IsoGa_PtTrig;
		delete histoCorrTrueGamma_IsoMin_Pt;
