...
/*
This function looks at the QA for gammas. It looks at the various aspects such as Pt, energy, for photons, electrons, and positrons. Make sure to set the proper path, look to see if the predifined varible values are what you want. If not, you'll have to set them in your QA_runwise.C
 */
