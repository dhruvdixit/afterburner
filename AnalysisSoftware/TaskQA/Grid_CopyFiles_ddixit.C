...
*///////////////////////////////////////////////////////////////////////////////////////
void Grid_CopyFiles(TString folder = "/home/dhruv/data/work/Grid", TString system = "pPb")
{
...
//    TString train = "Legotrain-vAN-20160206-8TeV_NL_4";
    TString train = "Legotrain-vAN-20160307-1";

    const Int_t nSets = 5;
    const Int_t nData = 5;
    TString DataSets[nSets]={"LHC13b_full_p3","LHC13c_full_p2","LHC13d_full_p2","LHC13e_full_p2","LHC13f_full_p2",};
...
//                             };
    Int_t trainRuns[nSets] = {536,537,538,539,540};

    TString runlistData = "merge_runlist_9";
    TString runlistMC = "merge_runlist_2";
    TString trigger = "kINT7";//V0 or //How do I inclue the EMC7,EG2, and EG1

//    const Int_t nFiles = 2;
//    TString Files[nFiles] = {"GammaCalo_111","GammaConvCalo_31"};

    const Int_t nFiles = 1;
    TString Files[nFiles] = {"GammaConvCalo_20"};

    const Int_t nMerge = 1;
    TString strMerge[nMerge]={"LHC13"};
