#include "QA.h"
#include "EventQA_Runwise_ddixit.C"
#include "PhotonQA_Runwise_ddixit.C"
#include "ClusterQA_Runwise_ddixit.C"
...
void QA_Runwise_ddixit(	
		       TString select = "LHC13",
		       Bool_t doEventQA = kTRUE,
		       Bool_t doPhotonQA = kTRUE,
		       Bool_t doClusterQA = kTRUE,
			...
			)
{
  ...
  //**************************************************************************************************************//Dhruv's data set to process
  if(select.CompareTo("LHC13")==0)
    {
      cout << "made it in Dhruv's data set" << endl;
      //LHC13g
      doEquidistantXaxis=kTRUE;
      fEnergyFlag = "2.76TeV";
      filePath = "/home/dhruv/afterburner/AnalysisSoftware/DataQA/20160307";
      fileName = "GammaConvCalo_20.root";
      //cutNr = 20;
      nSets = 10;
      nData = 10;
      
      DataSets[0]="LHC13b_pass3";
      DataSets[1]="LHC13c_pass2";
      DataSets[2]="LHC13d_pass2";
      DataSets[3]="LHC13e_pass2";
      DataSets[4]="LHC13f_pass2";
      DataSets[5]="LHC13b2_efix_p1";
      DataSets[6]="LHC13b2_efix_p2";
      DataSets[7]="LHC13b2_efix_p3";
      DataSets[8]="LHC13b2_efix_p4";
      DataSets[9]="LHC13e7";
      
      plotDataSets[0]="LHC13b_pass3";
      plotDataSets[1]="LHC13c_pass2";
      plotDataSets[2]="LHC13d_pass2";
      plotDataSets[3]="LHC13e_pass2";
      plotDataSets[4]="LHC13f_pass2";
      plotDataSets[5]="LHC13b2_efix_p1";
      plotDataSets[6]="LHC13b2_efix_p2";
      plotDataSets[7]="LHC13b2_efix_p3";
      plotDataSets[8]="LHC13b2_efix_p4";
      plotDataSets[9]="LHC13e7";
...
//**************************************************************************************************************
	if(doEventQA) 
	  EventQA_Runwise_ddixit(nSets,nData,fEnergyFlag,filePath,fileName,DataSets,plotDataSets,mode,cutNr,doExtQA,doEquidistantXaxis,doTrigger,doHistsForEverySet,addSubFolder,useDataRunListForMC,markerSize,suffix);
	if(doPhotonQA)
	  {
	    TString path = filePath;
	    if(!filePathPhoton.IsNull()) path = filePathPhoton;
	    PhotonQA_Runwise_ddixit(nSets,nData,fEnergyFlag,path,fileName,DataSets,plotDataSets,mode,cutNr,doExtQA,doEquidistantXaxis,doTrigger,doHistsForEverySet,addSubFolder,useDataRunListForMC,markerSize,suffix);
	  }
	if(doClusterQA) 
	  ClusterQA_Runwise_ddixit(nSets,nData,fEnergyFlag,filePath,fileName,DataSets,plotDataSets,mode,cutNr,doExtQA,doEquidistantXaxis,doTrigger,doHistsForEverySet,addSubFolder,useDataRunListForMC,markerSize,suffix);
	return;
}
