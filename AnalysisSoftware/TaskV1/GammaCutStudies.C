...
void GammaCutStudies(TString cutFile = "CombineCuts.dat",TString energy="",TString cutVariationName ="",TString suffix = "eps"){
   ...
   while(getline(in, currentCutNumber)){
      ...
      if(!number){
         cout<<"Std Cut:  Gamma: "<<gammaCutSelection[number]<<"   Meson: "<<mesonCutSelection[number]<<endl;
         cout<<"--------------------------"<<endl;
      }
      else cout<<"NCut: "<<number<<" Gamma:   "<<gammaCutSelection[number]<<"   Meson: "<<mesonCutSelection[number]<<endl;
      number++;
   }
   ...
   TCanvas *GammaSpectrumCanvas = GetAndSetCanvas("GammaSpectra");GammaSpectrumCanvas->SetLogy();GammaSpectrumCanvas->SetGridx();GammaSpectrumCanvas->SetGridy();
   TCanvas *Pi0SpectrumCanvas = GetAndSetCanvas("Pi0Spectra");Pi0SpectrumCanvas->SetLogy();Pi0SpectrumCanvas->SetGridx();Pi0SpectrumCanvas->SetGridy();
   TCanvas *Pi0SpectrumFitCanvas = GetAndSetCanvas("Pi0FitSpectra");Pi0SpectrumFitCanvas->SetLogy();Pi0SpectrumFitCanvas->SetGridx();Pi0SpectrumFitCanvas->SetGridy();
   ...
   TCanvas *GammaSpectrumRatioCanvas = GetAndSetCanvas("GammaSpectraRatio");GammaSpectrumRatioCanvas->SetGridx();GammaSpectrumRatioCanvas->SetGridy();
   TCanvas *Pi0SpectrumRatioCanvas = GetAndSetCanvas("Pi0SpectraRatio");Pi0SpectrumRatioCanvas->SetGridx();Pi0SpectrumRatioCanvas->SetGridy();
   TCanvas *Pi0SpectrumFitRatioCanvas = GetAndSetCanvas("Pi0FitSpectraRatio");Pi0SpectrumFitRatioCanvas->SetGridx();Pi0SpectrumFitRatioCanvas->SetGridy();
   ...
   TCanvas *PurityCanvas = GetAndSetCanvas("Purity");PurityCanvas->SetGridx();PurityCanvas->SetGridy();
   TCanvas *GammaEffCanvas = GetAndSetCanvas("GammaEff");

   TCanvas *RawGammaRatioCanvas = GetAndSetCanvas("RawGammaRatio");
   TCanvas *PurityRatioCanvas = GetAndSetCanvas("PurityRatio");PurityRatioCanvas->SetGridx();PurityRatioCanvas->SetGridy();
   TCanvas *GammaEffRatioCanvas = GetAndSetCanvas("GammaEffRatio");

   TLegend *GammaSpectrumLegend = GetAndSetLegend(0.3,0.7,number*0.7);
   TLegend *GammaSpectrumRatioLegend = GetAndSetLegend(0.15,0.75,number*0.7);
   TLegend *Pi0SpectrumLegend = GetAndSetLegend(0.3,0.7,number*0.7);
   TLegend *Pi0SpectrumRatioLegend = GetAndSetLegend(0.15,0.75,number*0.7);
   TLegend *Pi0SpectrumFitLegend = GetAndSetLegend(0.3,0.7,number*0.7);
   TLegend *Pi0SpectrumFitRatioLegend = GetAndSetLegend(0.15,0.75,number*0.7);
   TLegend *PurityLegend = GetAndSetLegend(0.2,0.3,number*0.7);
   TLegend *PurityRatioLegend = GetAndSetLegend(0.15,0.15,number*0.7);
   TLegend *GammaEffLegend = GetAndSetLegend(0.3,0.3,number*0.7);
   TLegend *GammaEffRatioLegend = GetAndSetLegend(0.15,0.75,number*0.7);
   TLegend *InclusiveGammaToPi0RatioLegend = GetAndSetLegend(0.3,0.7,number*0.7);
   TLegend *InclusiveGammaToPi0RatioRatioLegend = GetAndSetLegend(0.15,0.75,number*0.7);
   TLegend *InclusiveGammaToPi0RatioFitLegend = GetAndSetLegend(0.3,0.7,number*0.7);
   TLegend *InclusiveGammaToPi0RatioFitRatioLegend = GetAndSetLegend(0.15,0.75,number*0.7);
   TLegend *DirectPhotonDoubleRatioLegend = GetAndSetLegend(0.3,0.7,number*0.7);
   TLegend *DirectPhotonDoubleRatioRatioLegend = GetAndSetLegend(0.15,0.75,number*0.7);
   TLegend *DirectPhotonDoubleRatioFitLegend = GetAndSetLegend(0.3,0.7,number*0.7);
   TLegend *DirectPhotonDoubleRatioFitRatioLegend = GetAndSetLegend(0.15,0.75,number*0.7);
   // TLegend *DirectPhotonSpectrumLegend = GetAndSetLegend(0.3,0.7,number*0.7);
   // TLegend *DirectPhotonSpectrumRatioLegend = GetAndSetLegend(0.15,0.15,number*0.7);
   TLegend *RawGammaLegend = GetAndSetLegend(0.2,0.3,number*0.7);
   TLegend *RawGammaRatioLegend = GetAndSetLegend(0.15,0.15,number*0.7);
   ...
   for(Int_t i = 0; i<number; i++){
      ...
      currentCorrectedFile = Form("%s/%s/Gamma_Pi0_data_GammaConvV1_InclusiveRatio_%s_%s.root",cutSelection[i].Data(),energy.Data(),cutSelection[i].Data(),gammaCutSelection[i].Data());
      currentFinalFile[i] = new TFile(currentCorrectedFile);
  
      if(cutVariationName.CompareTo("ExtraSignals") == 0 && i == 2){
         currentCorrectedFile = Form("bonly/%s/%s/Gamma_Pi0_data_GammaConvV1_InclusiveRatio_%s_%s.root",cutSelection[i].Data(),energy.Data(),cutSelection[i].Data(),gammaCutSelection[i].Data());
         currentFinalFile[i] = new TFile(currentCorrectedFile);
      }
      ...
      if(i == 1 && cutVariationName.CompareTo("IntRange") == 0) InclusiveGammaToPi0Ratio[i] = (TH1D*) currentFinalFile[i]->Get("IncRatioPurity_trueEffWide");
      if(i == 2 && cutVariationName.CompareTo("IntRange") == 0) InclusiveGammaToPi0Ratio[i] = (TH1D*) currentFinalFile[i]->Get("IncRatioPurity_trueEffNarrow");
      ...
      if(i == 1 && cutVariationName.CompareTo("IntRange") == 0) Pi0Spectrum[i] = (TH1D*) currentFinalFile[i]->Get("CorrectedYieldTrueEffWide");
      if(i == 2 && cutVariationName.CompareTo("IntRange") == 0) Pi0Spectrum[i] = (TH1D*) currentFinalFile[i]->Get("CorrectedYieldTrueEffNarrow");
      ...
      if(i == 1 && cutVariationName.CompareTo("IntRange") == 0) Pi0SpectrumFit[i] = (TH1D*) currentFinalFile[i]->Get("CorrectedYieldTrueEffPi0FitWide");
      if(i == 2 && cutVariationName.CompareTo("IntRange") == 0) Pi0SpectrumFit[i] = (TH1D*) currentFinalFile[i]->Get("CorrectedYieldTrueEffPi0FitNarrow");
      ...
      InclusiveGammaToPi0RatioFit[i] = (TH1D*) currentFinalFile[i]->Get("histoIncRatioFitPurityA");
      if(i == 1 && cutVariationName.CompareTo("IntRange") == 0) InclusiveGammaToPi0RatioFit[i] = (TH1D*) currentFinalFile[i]->Get("histoIncRatioFitPurityWide");
      if(i == 2 && cutVariationName.CompareTo("IntRange") == 0) InclusiveGammaToPi0RatioFit[i] = (TH1D*) currentFinalFile[i]->Get("histoIncRatioFitPurityNarrow");
      if(i == 1 && cutVariationName.CompareTo("Fit") == 0) InclusiveGammaToPi0RatioFit[i] = (TH1D*) currentFinalFile[i]->Get("histoIncRatioLowFitPurity");
      if(i == 2 && cutVariationName.CompareTo("Fit") == 0) InclusiveGammaToPi0RatioFit[i] = (TH1D*) currentFinalFile[i]->Get("histoIncRatioHighFitPurity");
      ...
      if(i == 1 && cutVariationName.CompareTo("IntRange") == 0) DirectPhotonDoubleRatio[i] = (TH1D*) currentFinalFile[i]->Get("DoubleRatioConversionTrueEffPurityWide");
      if(i == 2 && cutVariationName.CompareTo("IntRange") == 0) DirectPhotonDoubleRatio[i] = (TH1D*) currentFinalFile[i]->Get("DoubleRatioConversionTrueEffPurityNarrow");
      ...
      if(i == 1 && cutVariationName.CompareTo("CocktailParam") == 0) DirectPhotonDoubleRatio[i] = (TH1D*) currentFinalFile[i]->Get("DoubleRatioConversionTrueEffPurityPi0ParamHigh");
      if(i == 2 && cutVariationName.CompareTo("CocktailParam") == 0) DirectPhotonDoubleRatio[i] = (TH1D*) currentFinalFile[i]->Get("DoubleRatioConversionTrueEffPurityPi0ParamLow");
      ...
      DirectPhotonDoubleRatioFit[i] = (TH1D*) currentFinalFile[i]->Get("DoubleRatioConversionFitPurityA");
      if(i == 1 && cutVariationName.CompareTo("IntRange") == 0) DirectPhotonDoubleRatioFit[i] = (TH1D*) currentFinalFile[i]->Get("DoubleRatioConversionFitPurityWide");
      if(i == 2 && cutVariationName.CompareTo("IntRange") == 0) DirectPhotonDoubleRatioFit[i] = (TH1D*) currentFinalFile[i]->Get("DoubleRatioConversionFitPurityNarrow");
      if(i == 1 && cutVariationName.CompareTo("Fit") == 0) DirectPhotonDoubleRatioFit[i] = (TH1D*) currentFinalFile[i]->Get("DoubleRatioConversionLowFitPurity");
      if(i == 2 && cutVariationName.CompareTo("Fit") == 0) DirectPhotonDoubleRatioFit[i] = (TH1D*) currentFinalFile[i]->Get("DoubleRatioConversionHighFitPurity");
      ...
      if(i == 1 && cutVariationName.CompareTo("CocktailParam") == 0) DirectPhotonDoubleRatioFit[i] = (TH1D*) currentFinalFile[i]->Get("DoubleRatioConversionFitPurityPi0ParamHigh");
      if(i == 2 && cutVariationName.CompareTo("CocktailParam") == 0) DirectPhotonDoubleRatioFit[i] = (TH1D*) currentFinalFile[i]->Get("DoubleRatioConversionFitPurityPi0ParamLow");
      ...
      PlotCanvas(i,number,GammaSpectrumCanvas,InclusiveGammaSpectrum[i],GammaSpectrumLegend,GammaSpectrumRatioCanvas,InclusiveGammaSpectrumRatio[i],GammaSpectrumRatioLegend,cutSelection[i],One);
      PlotCanvas(i,number,Pi0SpectrumCanvas,Pi0Spectrum[i],Pi0SpectrumLegend,Pi0SpectrumRatioCanvas,Pi0SpectrumRatio[i],Pi0SpectrumRatioLegend,cutSelection[i],One);
      PlotCanvas(i,number,Pi0SpectrumFitCanvas,Pi0SpectrumFit[i],Pi0SpectrumFitLegend,Pi0SpectrumFitRatioCanvas,Pi0SpectrumFitRatio[i],Pi0SpectrumFitRatioLegend,cutSelection[i],One);
      PlotCanvas(i,number,InclusiveGammaToPi0RatioCanvas,InclusiveGammaToPi0Ratio[i],InclusiveGammaToPi0RatioLegend,InclusiveGammaToPi0RatioRatioCanvas,InclusiveGammaToPi0RatioRatio[i],InclusiveGammaToPi0RatioRatioLegend,cutSelection[i],One);
      PlotCanvas(i,number,InclusiveGammaToPi0RatioFitCanvas,InclusiveGammaToPi0RatioFit[i],InclusiveGammaToPi0RatioFitLegend,InclusiveGammaToPi0RatioFitRatioCanvas,InclusiveGammaToPi0RatioFitRatio[i],InclusiveGammaToPi0RatioFitRatioLegend,cutSelection[i],One);
      PlotCanvas(i,number,DirectPhotonDoubleRatioCanvas,DirectPhotonDoubleRatio[i],DirectPhotonDoubleRatioLegend,DirectPhotonDoubleRatioRatioCanvas,DirectPhotonDoubleRatioRatio[i],DirectPhotonDoubleRatioRatioLegend,cutSelection[i],One,One);
      PlotCanvas(i,number,DirectPhotonDoubleRatioFitCanvas,DirectPhotonDoubleRatioFit[i],DirectPhotonDoubleRatioFitLegend,DirectPhotonDoubleRatioFitRatioCanvas,DirectPhotonDoubleRatioFitRatio[i],DirectPhotonDoubleRatioFitRatioLegend,cutSelection[i],One,One);
      //PlotCanvas(i,number,DirectPhotonSpectrumCanvas,DirectPhotonSpectrum[i],DirectPhotonSpectrumLegend,DirectPhotonSpectrumRatioCanvas,DirectPhotonSpectrumRatio[i],DirectPhotonSpectrumRatioLegend,cutSelection[i],One);
      ...
      PlotCanvas(i,number,RawGammaCanvas,RawGamma[i],RawGammaLegend,RawGammaRatioCanvas,RawGammaRatio[i],RawGammaRatioLegend,cutSelection[i],One);
      PlotCanvas(i,number,PurityCanvas,Purity[i],PurityLegend,PurityRatioCanvas,PurityRatio[i],PurityRatioLegend,cutSelection[i],One);
      PlotCanvas(i,number,GammaEffCanvas,GammaEff[i],GammaEffLegend,GammaEffRatioCanvas,GammaEffRatio[i],GammaEffRatioLegend,cutSelection[i],One);
   ...
   if(cutVariationName.CompareTo("CocktailEtaNorm") == 0 || cutVariationName.CompareTo("CocktailEta") == 0 || cutVariationName.CompareTo("CocktailParam") == 0 || cutVariationName.CompareTo("Yield") == 0 || cutVariationName.CompareTo("Fit") == 0 || cutVariationName.CompareTo("Purity") == 0){
   ...
   if(cutVariationName.CompareTo("Yield") == 0 || cutVariationName.CompareTo("Fit") == 0 || cutVariationName.CompareTo("Purity") == 0){
