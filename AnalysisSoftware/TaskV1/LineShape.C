...
void LineShape(const char *dataFilename = "rawSignalData", const char *mcFilename = "rawSignalMC", TString fCutSelection="", TString mesonType = "Pi0", TString fSuffix ="", TString energyFlag ="" ,Int_t numberOfBins=25,Int_t mode=0)
{
	gROOT->Reset();
