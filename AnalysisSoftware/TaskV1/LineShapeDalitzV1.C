...
void LineShapeDalitzV1(const char *dataFilename = "", const char *mcFilename = "", TString fCutSelection="", TString mesonType = "Pi0", TString fSuffix ="eps", TString energyFlag ="")
{
