...
void ProduceFinalGammaResults(TString inputFileName = "",TString systematicFileName = "",TString cutSel = "", TString option = ""){
   ...
   //DrawAliceLogoAdv(0.14,0.16,"Performance",option.Data(),"b",cocktailCanvasSpec,"",0);
   ...
   DrawSystem(0.27,0.16,option.Data(),(GetCentralityStringC(cutSel)).Data());
   //DrawAliceLogoAdv(0.14,0.16,"Performance",option.Data(),"b",cocktailCanvasMesonSpec,"",0);
   ...
   //DrawAliceLogoAdv(0.13,0.7,"Performance",option.Data(),"b",cocktailCanvasRatio,"",0);
   ...
   //DrawAliceLogoAdv(0.15,0.7,"Preliminary",option.Data(),"r",canvasDoubleRatio,(GetCentralityString(cutSel)).Data(),0);
   ...
   //DrawAliceLogoAdv(0.15,0.7,"Preliminary",option.Data(),"r",canvasDoubleRatioPi0Fit,(GetCentralityString(cutSel)).Data(),0);
   ...
   //DrawAliceLogoAdv(0.15,0.7,"Preliminary",option.Data(),"r",canvasDoubleRatioPi0FitPHOS,(GetCentralityString(cutSel)).Data(),0);
   ...
   //DrawAliceLogoAdv(0.15,0.7,"Preliminary",option.Data(),"r",canvasDoubleRatioPi0WithFitError,"",0);
   ...
   //DrawAliceLogoAdv(0.17,0.7,"Preliminary",option.Data(),"r",canvasIncRatio,(GetCentralityString(cutSel)).Data(),0);
   ...
   //DrawAliceLogoAdv(0.17,0.7,"Preliminary",option.Data(),"r",canvasIncRatioPi0Fit,(GetCentralityString(cutSel)).Data(),0);
   ...
   //DrawAliceLogoAdv(0.17,0.7,"Preliminary",option.Data(),"r",canvasPi0,(GetCentralityString(cutSel)).Data(),0);
   ...
   //DrawAliceLogoAdv(0.17,0.7,"Preliminary",option.Data(),"r",canvasPi0Fit,(GetCentralityString(cutSel)).Data(),0);
   ...
   //DrawAliceLogoAdv(0.8,0.7,"Preliminary",option.Data(),"l",canvasGammaSpectrumSingle,(GetCentralityString(cutSel)).Data(),0);
   ...
   //DrawAliceLogoAdv(0.8,0.7,"Preliminary",option.Data(),"l",canvasGammaSpectrumCombined,(GetCentralityString(cutSel)).Data(),0);
   ...
   //DrawAliceLogoAdv(0.15,0.7,"Preliminary",option.Data(),"r",canvasDoubleRatioPi0FitCharged,(GetCentralityString(cutSel)).Data(),0);
   ...
   //DrawAliceLogoAdv(0.8,0.7,"Preliminary",option.Data(),"r",canvasDoubleRatioPi0WithFitError,"",0);
...
SetStyleHistoTH1ForGraphs(dummy, "#it{p}_{T} (GeV/#it{c})","(#gamma_{inc}/#pi^{0})/(#gamma_{decay}/#pi^{0})", 0.85*textsizeLabelsBottom,textsizeLabelsBottom, 0.85*textsizeLabelsBottom,textsizeLabelsBottom, 1,0.5/(textsizeFacBottom*margin), 515, 409);
 dummy->DrawCopy();
   ...
   // //DrawAliceLogoAdv(0.8,0.7,"Preliminary",option.Data(),"l",canvasDirectPhotonWithShiftBlastWave,(GetCentralityString(cutSel)).Data(),0);
